...
/**
 * 路由到个人信息完善调整
 * @param int person_ret_state 用户注册状态
 * */
const navgationTopPerfectUserResume = (person_ret_state) => {

  if(600010 == person_ret_state){
    // 完善个人基本信息
    wx.navigateTo({
      url: '/pages/user_perfect_info/user_perfect_info',
    })
  }else if(600020 == person_ret_state){
    // 完善个人教育信息
    wx.navigateTo({
      url: '/pages/user_perfect_edu/user_perfect_edu',
    })
  }else if(600030 == person_ret_state){
    // 完善个人求职信息
    wx.navigateTo({
      url: '/pages/user_perfect_jw/user_perfect_jw',
    })
  }else if(600040 == person_ret_state){//保留
