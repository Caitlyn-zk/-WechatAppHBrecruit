...
{
  return request.get('wechat/get_logo', {}, { login : false});
}
...
export function getCoupons(data){
  return request.get('coupons',data,{login:false})
}
...
export function getArticleList(cid,data){
  return request.get('article/list/' + cid, data,{login:false})
}
...
export function registerVerify(code, key, phone, reset){
  return request.post('register/verify', { code: code, key: key, phone: phone, type: reset === undefined ? 'reset' : reset },{login:false})
}
...
{
  return request.get('wechat/teml_ids', {}, { login:false});
}
...
export function getLiveList(page,limit) {
  return request.get('wechat/live', { page, limit}, { login: false });
}
